...
x += xoffset*0
y += yoffset*1
mgmtsw = lab.create_node("mgmtsw", "unmanaged_switch", 0, 400)
...
spine = createNode("rt3", "dhcp", "iol-xe", (400, 100))
leaf1 = createNode("rt1", "dhcp", "ioll2-xe", (200, 300))
leaf2 = createNode("rt2", "dhcp", "ioll2-xe", (600, 300))
pc1 = createNode("pc1", "dhcp", "alpine", (200, 500))
pc2 = createNode("pc2", "dhcp", "alpine", (600, 500))


lab.connect_two_nodes(leaf1, spine) # et0-1.leaf1 - et0-1.sw1
lab.connect_two_nodes(leaf2, spine) # et0-1.leaf2 - et0-2.sw1
